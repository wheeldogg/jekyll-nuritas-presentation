...
BSc Genetics (UCC) 2010, MSc Immunology and Global Health (NUIM) 2012 |  HDip Data Science and Analytics (CIT) 2014
...
- **_HDip Data Science and Analytics 2014_**
...
<img src="/public/img/GermanyWC.png" alt="drawing" width="800px"/>
...
- Haproxy log file analytics: {% fragment %}
...
- Contribute to the development of an R package for internal data analytics. {% fragment %}
- Personalization project (e.g. twitter, betting history) {% fragment %}
- Migration of BI reports from MySQL to Cassandra and developing Spark processes. {% fragment %}
- I built fraud detection alerts (Linked users report) by using raw weblog data. {% fragment %}
- Customer realtionship management tracking via Salesforce APIS in python {% fragment %}
- I developed a "Prices" analytics app (NFTN tool) (Example below) {% fragment %}
...
- Bonus platform engine: {% fragment %}
 ...
 - Specifically worked on "DBStreams". This involved converting MySQL and Cassandra queries into python functions that could be run to retreive a "stream" of historical user interaction events stored in the database (combination of MySQL and Cassandra) {% fragment %}
...
- Developing a Python analytics package for easier access to re-usable and tested queries.  {% fragment %}

</small>

--

Worked in New Zealand as a BA/Data Scientist last year.
...
- Implement and help build the data analytics expertise and reporting in the company. {% fragment %}
...
- Good quality documentation ! {% fragment %}
...
Background in biological sciences (mostly through college MSC and BSc) and data science (HDip and commerical experience).

I've worked on various data sets using different analytics tools and hopefully can apply the skills I've learned in the biological sciences domain.

In the next section I'll describe in more detail the tools used and why I feel I'm a good match for the bioinformatician role.
