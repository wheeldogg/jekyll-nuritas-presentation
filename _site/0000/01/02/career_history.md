...
- Haproxy log file analytics and Big-data: <!-- .element: class="fragment" -->
...
- R package development (e.g. IP address conversion etc.) <!-- .element: class="fragment" -->
- Personalization projects (e.g. Twitter app, betting statistics and user skill) <!-- .element: class="fragment" -->
- Data analytics migration from MySQL to Cassandra and developing Spark processes. I created python modules that were distributed in Spark (ie. custom pandas functions), also acted as knowledge source of database structure. <!-- .element: class="fragment" -->
- CRM tracking via Salesforce APIS in python <!-- .element: class="fragment" -->
- Data analytics innovation lab (DAIL): I developed a "Betting Prices analytics" app (NFTN tool) <!-- .element: class="fragment" -->
...
<img src="/public/img/article_with_graph.png" alt="drawing" width="550px"/> <img src="/public/img/heatmap.jpg" alt="drawing" width="550px"/>
...
- Bonus platform engine: <!-- .element: class="fragment" -->
 ...
 - Specifically I worked on "DBStreams". This involved converting MySQL and Cassandra queries into python functions that could be run to retreive a "stream" of historical user interaction events stored in the database (combination of MySQL and Cassandra as an event stream of JSON objects) <!-- .element: class="fragment" -->
...
- Developing a Python analytics package for easier access to re-usable and tested queries. I worked on functions such as commision calculations, pnl etc. <!-- .element: class="fragment" -->
...
- Helped build the data analytics expertise and reporting in the company. <!-- .element: class="fragment" -->
